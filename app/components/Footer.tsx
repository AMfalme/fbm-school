        ...
        <div className="grid gap-8 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="mailto:admissions@fbm-school.org" className="text-[#FFD966] hover:text-white transition">
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-[#FFD966]">Contact Info</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t border-slate-700">
              <p className="text-xs text-slate-400">
                Part of Freedom Baptist Mission's vision to reach Kenya and beyond with the transformative message of Jesus Christ.
              </p>
            </div>
          </div>
        </div>
