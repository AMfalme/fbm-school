...
export default function FaithAcademy() {
  // Central active state controller for the section tab navigationmatrix
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF9] text-slate-900 selection:bg-[#FFD966] selection:text-[#003d7a]">
      ...
      <div className="bg-[#003d7a] text-center px-4 py-2.5 text-xs font-bold uppercase tracking-widest text-white">
