        ...
        <nav className="mt-4 rounded-2xl border border-slate-800 bg-slate-950 p-3 text-sm font-semibold uppercase text-white">
          <div className="flex flex-col gap-2">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900">
              <button
                type="button"
                onClick={() => setOurMissionOpen(!ourMissionOpen)}
              ...
              {ourMissionOpen && (
                <div className="grid grid-cols-1 gap-1 border-t border-slate-800 p-2 text-[13px] normal-case">
                  <a
                    href="/about"
                    onClick={closeMenu}
